//
//  OrgCreateSettingsTableViewCell.swift
//  MyCity
//
...
protocol OrgCreateSettingsTableViewCellDelegate {
    func changedSwitchValue(category: String, value: Bool)
}

class OrgCreateSettingsTableViewCell: UITableViewCell {

    var delegate: OrgCreateSettingsTableViewController?
