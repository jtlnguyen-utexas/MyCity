//
//  OrgSettingsTableViewCell.swift
//  MyCity
//
...
protocol OrgSettingsTableViewCellDelegate {
    func changedSwitchValue(category: String, value: Bool)
}

class OrgSettingsTableViewCell: UITableViewCell {

    var delegate: OrgSettingsTableViewController?
